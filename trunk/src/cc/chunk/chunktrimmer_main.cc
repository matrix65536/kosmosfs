...
static void trimFile(string &fn, off_t filesz, bool verbose);
...
static int trimPart(int fd, off_t startP, off_t endP, int blkSz, int &numFreed, int &numKept);
...
static int
trimPart(int fd, off_t startP, off_t endP, int blkSz, int &numFreed, int &numKept)
{
